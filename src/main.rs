...
impl FloatingImage {
  fn new(width: u32, height: u32, name: String) -> Self {
    let buffer_capacity = height * width * 4; // height * width * 4 for a dynamic value, or bigger images like RGBA. Or simply use 3_655_744 value.
...
fn alternate_pixels(vec_1: Vec<u8>, vec_2: Vec<u8>) -> Vec<u8> {
  // If vec_1.len() == 5, [0, 0, 0, 0, 0] will be created
